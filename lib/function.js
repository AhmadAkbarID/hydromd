...
async function listbut2(hydro, m, teks, listnye) {
    ...
    // Cek apakah tipenya video atau GIF
    ...
    return {
        ...
        sections: [
            ...
            },
            {
                ...
                highlight_label: ``,
                rows: [
                    { title: "ᴘᴇʀᴀᴛᴜʀᴀɴ", description: "🎉 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ᴀᴛᴜʀᴀɴ", id: `${p}bacaperaturan` },
                    { title: "ᴅᴏɴᴀsɪ", description: "💸 ᴅᴏɴᴀsɪ ʙᴏᴛ ᴀɢᴀʀ ᴅᴀᴘᴀᴛ ʙᴇʀᴋᴇᴍʙᴀɴɢ", id: `${p}donasi` },
                    ...
                    { title: "ғɪᴛᴜʀ ɢᴀᴍᴇ", description: "🎮 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ᴘᴇʀᴍᴀɪɴᴀɴ", id: `${p}gamemenu` },
                    { title: "ғɪᴛᴜʀ sʜᴏᴘ", description: "🛍️ ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ғɪᴛᴜʀ ᴊᴇʙᴇʜ", id: `${p}storemenu` },
                    { title: "ғɪᴛᴜʀ ᴄᴘᴀɴᴇʟ", description: "🛠️ ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ᴄʀᴇᴀᴛᴇ ᴘᴀɴᴇʟ", id: `${p}cpanelmenu` },
                    { title: "ғɪᴛᴜʀ ᴘᴜsʜ", description: "💾 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ᴘᴜsʜ", id: `${p}pushmenu` },
                    { title: "ғɪᴛᴜʀ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ", description: "📂 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ᴅᴏᴇɴʟᴏᴀᴅ ɪɢ/ᴛᴛ/ʏᴛ ᴅʟʟ", id: `${p}downloadmenu` },
                    { title: "ғɪᴛᴜʀ ᴀɪ", description: "🤖 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ᴀɪ", id: `${p}aimenu` },
                    { title: "ғɪᴛᴜʀ 18+", description: "🔞 ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ғɪᴛᴜʀ 18+", id: `${p}nsfwmenu` },
                    { title: "ғɪᴛᴜʀ ᴀɴɪᴍᴇ", description: "🤍 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ᴀɴɪᴍᴇ", id: `${p}animemenu` },
                    { title: "ғɪᴛᴜʀ ᴇᴅɪᴛ ғᴏᴛᴏ", description: "🖼️ ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ᴇᴅɪᴛ ғᴏᴛᴏ", id: `${p}ephoto360menu` },
                    { title: "ғɪᴛᴜʀ sᴇʀᴜ", description: "🥳 ᴍᴇɴᴀᴍᴘɪʟᴋᴀɴ ғɪᴛᴜʀ ᴍᴇɴʏᴇɴᴀɴɢᴋᴀɴ", id: `${p}funmenu` },
                    { title: "ғɪᴛᴜʀ ɪsʟᴀᴍ", description: "🕌 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ɪsʟᴀᴍ", id: `${p}islamimenu` },
                    { title: "ғɪᴛᴜʀ ᴅᴀᴛᴀʙᴀsᴇ", description: "🖥️ ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ᴅᴀᴛᴀʙᴀsᴇ", id: `${p}databasemenu` },
                    { title: "ғɪᴛᴜʀ ʟᴀɪɴ-ʟᴀɪɴ", description: "📪 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ᴛɪᴅᴀᴋ ᴅɪᴋᴀᴛᴇɢᴏʀɪᴋᴀɴ", id: `${p}othermenu` },
                    { title: "ғɪᴛᴜʀ ʀᴘɢ", description: "🧰 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ʀᴘɢ", id: `${p}rpgmenu` },
                    { title: "ғɪᴛᴜʀ ᴄsᴜʙᴅᴏ", description: "🌐 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ᴄʀᴇᴀᴛᴇ sᴜʙᴅᴏᴍᴀɪɴ", id: `${p}domainmenu` },
                    { title: "ғɪᴛᴜʀ ᴀɴᴏɴʏᴍᴏᴜsᴇ", description: "👤 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ᴀɴᴏɴʏᴍᴏᴜsᴇ", id: `${p}anonymousmenu` },
                    { title: "ғɪᴛᴜʀ ʀᴠɪᴅᴇᴏ", description: "🎥 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ʀᴀɴᴅᴏᴍ ᴠɪᴅᴇᴏ", id: `${p}randomvideomenu` },
                    { title: "ғɪᴛᴜʀ ʀᴘʜᴏᴛᴏ", description: "📷 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ʀᴀɴᴅᴏᴍ ғᴏᴛᴏ", id: `${p}randomphotomenu` },
                    { title: "ғɪᴛᴜʀ sᴛɪᴄᴋᴇʀ", description: "📝 ᴍᴇᴍᴜɴᴄᴜᴋᴀɴ ғɪᴛᴜʀ sᴛɪᴄᴋᴇʀ", id: `${p}stickermenu` },
                    { title: "ғɪᴛᴜʀ ǫᴜᴏᴛᴇs", description: "💬 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ᴋᴀᴛᴀ-ᴋᴀᴛᴀ", id: `${p}quotesmenu` },
                    { title: "ғɪᴛᴜʀ sᴛᴀʟᴋ", description: "🔍 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ sᴛᴀʟᴋɪɴɢ", id: `${p}stalkermenu` },
                    { title: "ғɪᴛᴜʀ ʙᴜɢ ᴡᴀ", description: "🐛 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ʙᴜɢ", id: `${p}bugmenu` },
                    { title: "ғɪᴛᴜʀ ᴅɪɢɪᴛᴀʟᴏᴄᴇᴀɴ", description: "🌐 ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ᴅɪɢɪᴛᴀʟᴏᴄᴇᴀɴ", id: `${p}digitaloceanmenu` },
                    { title: "ғɪᴛᴜʀ ᴘᴛᴇʀᴏᴅᴀᴄᴛʏʟ", description: "⚙ ᴍᴇᴍᴜɴᴄᴜʟᴋᴀɴ ғɪᴛᴜʀ ᴘᴛᴇʀᴏᴅᴀᴄᴛʏʟ", id: `${p}pyterodactylemenu` }
                ]
            },
            {
                title: `ʟᴀɪɴɴʏᴀ`, 
                highlight_label: ``,
                rows: [
                    { title: "sᴄʀɪᴘᴛ", description: "💳 sᴄ ɪɴɪ ғʀᴇᴇ ɴᴏ ᴇɴᴄ 100%", id: `${p}script` },
                ...
                if (gc.jadwalsholatData && gc.jadwalsholatData.date === dateStr) {
                    ...
                    for (let s of sholatTimes) {
                        if (currentTime === s.time && !notified.includes(s.name)) {
                            try {
                                let groupMeta = await hydro.groupMetadata(jid).catch(e => null);
                                let participantIds = groupMeta ? groupMeta.participants.map(a => a.id) : [];
