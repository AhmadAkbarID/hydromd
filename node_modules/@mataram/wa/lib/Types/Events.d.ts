...
export type MataramEvent = keyof MataramEventMap;
export interface MataramEventEmitter {
    ...
    removeAllListeners<T extends keyof MataramEventMap>(event: T): void;
