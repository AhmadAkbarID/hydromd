...
export type SocketConfig = {
    ...
    /** should use the mobile api instead of the multi device api
    ...
    /** Should ask the phone for full history, will be received async */
    syncFullHistory: boolean;
    /** Should fire init queries automatically, default true */
