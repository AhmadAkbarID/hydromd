...
import type { MataramEventEmitter, MataramEventMap, Contact } from '../Types/index.js';
...
export type LidMappingUpdateResult = {
    ...
    data: MataramEventMap['lid-mapping.update'];
};
...
export declare const emitSyncActionResults: (ev: MataramEventEmitter, results: SyncActionResult[]) => void;
