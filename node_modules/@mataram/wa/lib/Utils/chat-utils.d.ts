...
import type { MataramEventEmitter, ChatModification, ChatMutation, Contact, InitialAppStateSyncOptions, LTHashState, WAPatchCreate, WAPatchName } from '../Types/index.js';
 ...
 * We retry with a snapshot which may use a different key.
 */
...
export declare const processSyncAction: (syncAction: ChatMutation, ev: MataramEventEmitter, me: Contact, initialSyncOpts?: InitialAppStateSyncOptions, logger?: ILogger) => void;
export {};
