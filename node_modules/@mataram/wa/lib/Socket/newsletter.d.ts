import type { SocketConfig, WAMediaUpload, WAMessage } from '../Types/index.js';
...
export declare const makeNewsletterSocket: (config: SocketConfig) => {
    ...
    ev: import("../index.js").MataramEventEmitter & {
        process(handler: (events: Partial<import("../index.js").MataramEventMap>) => void | Promise<void>): () => void;
        buffer(): void;
